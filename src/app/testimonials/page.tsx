  ...
  return (
    <>
      ...
      <div className="flex flex-col pt-3 max-w-[1200px] m-auto lg:flex-row-reverse">
        <div className="flex max-w-full h-[250px] overflow-hidden lg:w-1/2 lg:rounded-r-md lg:h-[400px]">
          <div className="w-1/2">
            <Image src={fatImg} alt="fat" className="" />
          </div>
          <div className="w-1/2">
        ...
        <div className="lg:w-1/2 text-center px-3 py-3 lg:px-4 lg:pt-14 bg-button-secondary lg:rounded-l-md">
